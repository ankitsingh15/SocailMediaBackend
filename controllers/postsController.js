...
const { success, error } = require("../utils/responsiveWrapper");
const cloudinary = require("cloudinary");
const mapPostOutput = require("../utils/Utils");

const getAllPostController = async (req, res) => {
  console.log(req._id);
  // return res.send("in PostsController");
  return res.send(success(201, "in PostsController"));
};
...
const likeAndUnlikePost = async (req, res) => {
  try {
    ...
    await post.save();
    console.log("map output is ", mapPostOutput(post));
